...
int main() {
	...
	while(getline())      // Parsing through studentData and placing it to memory(box)     stringstream lookup    forloop needed atleast 5 times stream studentdata include variables for said data
